## Words/Names to Remember
* 刺激
    <a href="plecoapi://x-callback-url/df?hw=(刺激)&py=pinyin&sec=dict&x-source=&x-success=())">pleco</a> [Wiktionary](https://en.wiktionary.org/wiki/刺激)
* 情况 [pleco](plecoapi://x-callback-url/df?hw=(情况)&py=pinyin&sec=dict&x-source=&x-success=()) [Wiktionary](https://en.wiktionary.org/wiki/情况)
* 推出 [pleco](plecoapi://x-callback-url/df?hw=(推出)&py=pinyin&sec=dict&x-source=&x-success=()) [Wiktionary](https://en.wiktionary.org/wiki/推出)
* 补充 [pleco](plecoapi://x-callback-url/df?hw=(补充)&py=pinyin&sec=dict&x-source=&x-success=()) [Wiktionary](https://en.wiktionary.org/wiki/补充)
* 计划 [pleco](plecoapi://x-callback-url/df?hw=(计划)&py=pinyin&sec=dict&x-source=&x-success=()) [Wiktionary](https://en.wiktionary.org/wiki/计划)
* 预算 [pleco](plecoapi://x-callback-url/df?hw=(预算)&py=pinyin&sec=dict&x-source=&x-success=()) [Wiktionary](https://en.wiktionary.org/wiki/预算)
