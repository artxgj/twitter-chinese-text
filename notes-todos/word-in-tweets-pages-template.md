[previous page](ola) | [next page](hi)
# 核酸检测
___

Search [mdbg](https://www.mdbg.net/chinese/dictionary?page=worddict&wdrst=0&wdqb=核酸检测)

Search [Wiktionary](https://en.wiktionary.org/wiki/核酸检测)
