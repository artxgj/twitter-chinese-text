...
##### Other Words/Names of Interest in the Above Tweet
[指出](指出.md), [计划](计划.md), [芯片](芯片.md), [缓解](缓解.md), [引述](引述.md), [台积电](台积电.md), [短缺](短缺.md), [需求](需求.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[半导体](半导体.md), [局面](局面.md), [生产](生产.md), [眼下](眼下.md), [投资](投资.md), [产业](产业.md)
