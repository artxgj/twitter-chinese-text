...
##### Other Words/Names of Interest in the Above Tweet
[关注](关注.md), [加密](加密.md), [加密货币](加密货币.md), [因此](因此.md), [因素](因素.md), [引发](引发.md), [总结](总结.md), [状况](状况.md), [监管](监管.md), [行为](行为.md), [规模](规模.md), [货币](货币.md), [领域](领域.md)
___
