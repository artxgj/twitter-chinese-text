...
[产业](产业.md), [依赖](依赖.md), [实施](实施.md), [库存](库存.md), [影响](影响.md), [日本](日本.md), [稀有](稀有.md), [管制](管制.md), [获得](获得.md), [遭受](遭受.md), [金属](金属.md), [镓](镓.md), [随着](随着.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[劳动](劳动.md), [型](型.md), [禁止](禁止.md), [美国](美国.md), [行为](行为.md), [采取](采取.md)
___
