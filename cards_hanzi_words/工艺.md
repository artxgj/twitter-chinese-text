...
[信用](信用.md), [恢复](恢复.md), [放宽](放宽.md), [模式](模式.md), [电商](电商.md), [限制](限制.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[三星](三星.md), [半导体](半导体.md), [台积电](台积电.md), [情况](情况.md), [技术](技术.md), [纳米](纳米.md), [芯片](芯片.md), [计划](计划.md), [超过](超过.md), [量产](量产.md)
___
