...
[丹麦](丹麦.md), [俄罗斯](俄罗斯.md), [北溪](北溪.md), [天然气](天然气.md), [德国](德国.md), [股份](股份.md), [调查](调查.md), [麦](麦.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[三星](三星.md), [半导体](半导体.md), [厂商](厂商.md), [台积电](台积电.md), [库存](库存.md), [应对](应对.md), [相关](相关.md), [美国](美国.md), [距离](距离.md), [透露](透露.md)
___
