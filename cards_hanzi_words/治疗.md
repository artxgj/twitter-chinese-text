...
##### Other Words/Names of Interest in the Above Tweet
[允许](允许.md), [冠病病毒](冠病病毒.md), [发布](发布.md), [恢复](恢复.md), [感染](感染.md), [抗原](抗原.md), [指南](指南.md), [提出](提出.md), [核酸检测](核酸检测.md), [检测](检测.md), [病毒](病毒.md), [症状](症状.md), [确诊](确诊.md), [连续](连续.md), [间隔](间隔.md), [隔离](隔离.md)
___
