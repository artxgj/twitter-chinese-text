...
[下酒菜](下酒菜.md), [日本](日本.md), [椒](椒.md), [消费者](消费者.md), [熟悉](熟悉.md), [菜](菜.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[一直](一直.md), [关税](关税.md), [包括](包括.md), [华为](华为.md), [协议](协议.md), [建设](建设.md), [投资](投资.md), [澳大利亚](澳大利亚.md), [煤炭](煤炭.md), [税](税.md), [签署](签署.md), [贸易](贸易.md), [麦](麦.md)
