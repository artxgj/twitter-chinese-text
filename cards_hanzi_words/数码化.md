...
[上涨](上涨.md), [不仅](不仅.md), [促进](促进.md), [压力](压力.md), [型](型.md), [小贩](小贩.md), [提高](提高.md), [竞争](竞争.md), [购物](购物.md), [转型](转型.md), [进程](进程.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[使用率](使用率.md), [华侨银行](华侨银行.md), [反应](反应.md), [威胁](威胁.md), [导致](导致.md), [损](损.md), [陷入](陷入.md)
___
