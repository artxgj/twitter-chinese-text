...
[物流](物流.md), [交货](交货.md), [航线](航线.md), [成本](成本.md), [沃尔玛](沃尔玛.md), [延迟](延迟.md), [亚马逊](亚马逊.md), [巨头](巨头.md), [运输](运输.md), [货主](货主.md), [拥堵](拥堵.md), [线上](线上.md), [应对](应对.md), [港口](港口.md), [导致](导致.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[需求](需求.md), [速度](速度.md), [集装箱](集装箱.md), [航运](航运.md), [超过](超过.md), [短缺](短缺.md), [货船](货船.md), [推动](推动.md), [规模](规模.md), [随着](随着.md), [运输](运输.md), [港口](港口.md), [分析](分析.md)
