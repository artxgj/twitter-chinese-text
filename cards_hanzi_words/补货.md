...
[巨头](巨头.md), [导致](导致.md), [拥堵](拥堵.md), [港口](港口.md), [航线](航线.md), [成本](成本.md), [应对](应对.md), [延迟](延迟.md), [沃尔玛](沃尔玛.md), [货主](货主.md), [运输](运输.md), [交货](交货.md), [物流](物流.md), [亚马逊](亚马逊.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[港口](港口.md), [短缺](短缺.md), [集装箱](集装箱.md), [规模](规模.md), [超过](超过.md), [需求](需求.md), [推动](推动.md), [运输](运输.md), [分析](分析.md), [随着](随着.md), [货船](货船.md), [速度](速度.md)
