...
##### Other Words/Names of Interest in the Above Tweet
[价格](价格.md), [伴随](伴随.md), [处于](处于.md), [影响](影响.md), [成本](成本.md), [指出](指出.md), [水平](水平.md), [用于](用于.md), [电池](电池.md), [碳](碳.md), [纯电动汽车](纯电动汽车.md), [脱碳](脱碳.md), [趋势](趋势.md), [逾](逾.md), [金属](金属.md), [锂](锂.md), [阻碍](阻碍.md), [需求](需求.md)
___
