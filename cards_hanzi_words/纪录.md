...
##### Other Words/Names of Interest in the Above Tweet
[三星](三星.md), [净利润](净利润.md), [利润](利润.md), [增长](增长.md), [存储](存储.md), [季度](季度.md), [拖累](拖累.md), [推动](推动.md), [收入](收入.md), [放缓](放缓.md), [短缺](短缺.md), [科技](科技.md), [组装](组装.md), [芯片](芯片.md), [随着](随着.md), [零部件](零部件.md), [需求](需求.md)
____
