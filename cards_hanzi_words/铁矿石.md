...
##### Other Words/Names of Interest in the Above Tweet
[上涨](上涨.md), [买入](买入.md), [价格](价格.md), [原油](原油.md), [商品](商品.md), [复苏](复苏.md), [大宗商品](大宗商品.md), [天然气](天然气.md), [押注](押注.md), [推动](推动.md), [政策](政策.md), [棉花](棉花.md), [液化天然气](液化天然气.md), [用于](用于.md), [相关](相关.md), [突出](突出.md), [镍](镍.md), [预期](预期.md)
___
