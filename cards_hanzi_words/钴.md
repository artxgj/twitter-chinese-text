...
##### Other Words/Names of Interest in the Above Tweet
[严格](严格.md), [供应链](供应链.md), [加工](加工.md), [半导体](半导体.md), [实行](实行.md), [崛起](崛起.md), [持续](持续.md), [生产](生产.md), [相关](相关.md), [纯电动汽车](纯电动汽车.md), [美国](美国.md), [行业](行业.md), [进行](进行.md), [遏制](遏制.md), [锂](锂.md), [限制](限制.md)
___
