...
##### Other Words/Names of Interest in the Above Tweet
[计算机](计算机.md), [型](型.md), [加密](加密.md), [领域](领域.md), [电商](电商.md), [计划](计划.md), [资产](资产.md), [开发](开发.md), [技术](技术.md), [量子](量子.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[设想](设想.md), [厂商](厂商.md), [应对](应对.md), [属实](属实.md), [竞争](竞争.md), [实力](实力.md), [丰田](丰田.md), [影响](影响.md), [特斯拉](特斯拉.md), [苹果](苹果.md), [格局](格局.md), [消耗战](消耗战.md), [核心](核心.md), [玩家](玩家.md)
