...
[气候变化](气候变化.md), [燃料](燃料.md), [超过](超过.md), [有史以来](有史以来.md), [影响](影响.md), [设施](设施.md), [损](损.md), [规模](规模.md), [导致](导致.md), [柴油](柴油.md), [根据](根据.md), [泄漏](泄漏.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[随着](随着.md), [开采](开采.md), [地缘政治](地缘政治.md), [控制](控制.md), [优势](优势.md), [航线](航线.md)
