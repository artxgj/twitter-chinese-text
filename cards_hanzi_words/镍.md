...
##### Other Words/Names of Interest in the Above Tweet
[下跌](下跌.md), [交易](交易.md), [价格](价格.md), [关键](关键.md), [动荡](动荡.md), [推高](推高.md), [放缓](放缓.md), [数据](数据.md), [根据](根据.md), [用于](用于.md), [电池](电池.md), [累计](累计.md), [谨慎](谨慎.md), [逾](逾.md), [金属](金属.md), [钴](钴.md), [锂](锂.md), [需求](需求.md)
___
