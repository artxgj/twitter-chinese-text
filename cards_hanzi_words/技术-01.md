...
##### Other Words/Names of Interest in the Above Tweet
[不仅](不仅.md), [卫星](卫星.md), [导致](导致.md), [损](损.md), [支援](支援.md), [收集](收集.md), [数据](数据.md), [日本](日本.md), [直接](直接.md), [研发](研发.md), [覆盖](覆盖.md), [需求](需求.md), [驾驶](驾驶.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[举措](举措.md), [发行](发行.md), [广泛](广泛.md), [影响](影响.md), [操作](操作.md), [政策](政策.md), [数据](数据.md), [标志](标志.md), [渠道](渠道.md), [系统](系统.md), [苹果](苹果.md), [预计](预计.md)
___
