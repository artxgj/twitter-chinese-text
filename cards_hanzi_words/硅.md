...
##### Other Words/Names of Interest in the Above Tweet
[东芝](东芝.md), [包括](包括.md), [半导体](半导体.md), [厂商](厂商.md), [原材料](原材料.md), [扩大](扩大.md), [用于](用于.md), [确保](确保.md), [碳](碳.md), [碳化硅](碳化硅.md), [稳定](稳定.md), [纯电动汽车](纯电动汽车.md), [罗姆](罗姆.md), [规模](规模.md), [需求](需求.md), [预计](预计.md)
___
