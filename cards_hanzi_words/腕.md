...
[控制](控制.md), [至少](至少.md), [进行](进行.md), [苹果](苹果.md), [执行](执行.md), [平台](平台.md), [批准](批准.md), [竞争](竞争.md), [支付](支付.md), [推迟](推迟.md), [获得](获得.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[调查](调查.md), [根据](根据.md), [菲律宾](菲律宾.md), [初步](初步.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[如今](如今.md), [依然](依然.md), [引发](引发.md), [传统](传统.md)
