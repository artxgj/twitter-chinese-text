...
from tweetybird import TweetsDateInterval, OriginatorsOfRetweets


def extract_tweets(tweets: Iterator, retweet_origins: OriginatorsOfRetweets,
...
if __name__ == '__main__':
    ...
    tweets_originators = OriginatorsOfRetweets("screen_name",
